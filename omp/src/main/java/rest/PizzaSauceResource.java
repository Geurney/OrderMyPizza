 ...
 *
 */
public class PizzaSauceResource implements
		PizzaComponentResourceInterface<PizzaSauce> {
	@Context
	UriInfo uriInfo;
	@Context
	Request request;
	...
	/**
	 * Pizza Sauce Resource Constructor
	 * 
	 * @param uriInfo
	 *            uriInfo
	 * @param request
	...
	/**
	 * Get Pizza Sauce in datastore. This operation fails on following
	 * conditions:1.the PizzaFactory is not found. 2.Pizza Sauces are empty in
	 * the PizzaFactory 3.This Pizza Sauce is not found.
	 * 
	 * @return Pizza Sauce
	 */
	@Override
	public PizzaSauce getPizzaComponent() {
		String hash_uid = UserUtils.getCurrentUserObscureID();
		return findPizzaComponent(hash_uid);
	}

	/**
	 * Find Pizza Sauce in datastore with token for curl. This operation fails
	 * on following conditions:1.the PizzaFactory is not found. 2.Pizza Sauces
	 * are empty in the PizzaFactory 3.This Pizza Sauce is not found.
	 * 
	 * @param token
	 *            Pizza Factory token
	 * @return Pizza Sauce
	 */
	@Override
	public PizzaSauce getPizzaComponent(@PathParam("token") String token) {
		return findPizzaComponent(token);
	}

	/**
	 * 
	 * Update the Pizza Sauce in PizzaFactory with form. This operation fails on
	 * following conditions: 1.the PizzaFactory is not found. 2.Pizza Sauces are
	 * empty in the PizzaFactory 3.This Pizza Sauce is not found. 4.New
	...
	/**
	 * 
	 * Update the Pizza Sauce in PizzaFactory with form with token for curl.
	 * This operation fails on following conditions: 1.the PizzaFactory is not
	 * found. 2.Pizza Sauces are empty in the PizzaFactory 3.This Pizza Sauce is
	...
	/**
	 * Update the Pizza Sauce in Pizza Factory with JSON
	 * 
	 * @param component
	 *            Pizza Sauce
	 */
	@Override
	public void putPizzaComponent(PizzaSauce component) {
		String hash_uid = UserUtils.getCurrentUserObscureID();
	...
	/**
	 * Update the Pizza Sauce in PizzaFactory with JSON with token for curl
	 * 
	 * @param token
	 *            Pizza Factory token
	 * @param component
	...
	/**
	 * Delete Pizza Sauce with token for curl
	 * 
	 * @param token
	 *            Pizza Factory token
	 */
	...
	/**
	 * Find Pizza Sauce in datastore. This operation fails on following
	 * conditions:1.the PizzaFactory is not found. 2.Pizza Sauces are empty in
	 * the PizzaFactory 3.This Pizza Sauce is not found.
	 * 
	 * 
	...
	private PizzaSauce findPizzaComponent(String token) {
		if (token == null) {
			return null;
		}
		PizzaSauce component = null;
	...
	/**
	 * Update the Pizza Sauce in PizzaFactory. This operation fails on following
	 * conditions: 1.the PizzaFactory is not found. 2.Pizza Sauces are empty in
	 * the PizzaFactory 3.This Pizza Sauce is not found. 4.New
	 * identifier(different from current) already exists. 5. Original
	 * costs/prices are not set.
	 * 
	 * @param token
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static PizzaSauce entityToObject(EmbeddedEntity entity) {
		if (entity == null) {
			return null;
		}
		PizzaSauce component = new PizzaSauce();
