...
public class CustomerOrderResource {
	...
	private void newOrder(String token, String pizzaShop, String size,
		...
		if (pizzaFactory.hasCrust(crust)) {
		...
		if (pizzaFactory.hasSauce(sauce)) {
		...
		if (meat1 != null && !meat1.equals("None")) {
			if (pizzaFactory.hasMeat(meat1)) {
				meats.add(meat1);
			} else {
				return;
			}
		...
		if (meat2 != null && !meat2.equals("None")) {
			if (pizzaFactory.hasMeat(meat2)) {
				meats.add(meat2);
			} else {
				return;
			}
		}
		if (meat3 != null && !meat3.equals("None")) {
			if (pizzaFactory.hasMeat(meat3)) {
				meats.add(meat3);
			} else {
				return;
			}
		...
		if (veg1 != null && !veg1.equals("None")) {
			if (pizzaFactory.hasMeat(veg1)) {
				vegs.add(veg1);
			} else {
				return;
			}
		}
		if (veg2 != null && !veg2.equals("None")) {
			if (pizzaFactory.hasMeat(veg2)) {
				vegs.add(veg2);
			} else {
				return;
			}
		}
		if (veg3 != null && !veg3.equals("None")) {
			if (pizzaFactory.hasMeat(veg3)) {
				vegs.add(veg3);
			} else {
				return;
			}
